...
### SOLID-2: DomainError manca variante Network/IO [COMPLETATO]
...
### SOLID-5: Domain model senza invarianti — PartType, Assignment, Proclamatore [COMPLETATO]
...
### I18N-2: SexRule.name mostrato direttamente nella UI [COMPLETATO]
