...
data class SuggestionRankingCache(
    ...
    val conductorBeforeByDate: Map<LocalDate, Map<String, String?>>,
    val conductorAfterByDate: Map<LocalDate, Map<String, String?>>,
    val nearestAssignmentWasConductorByDate: Map<LocalDate, Map<String, Boolean>>,
