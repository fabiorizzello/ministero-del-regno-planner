...
// Re-exported from core so existing UI call-sites keep compiling.
// New code should import directly from org.example.project.core.formatting.
internal val dateFormatter get() = org.example.project.core.formatting.dateFormatter
fun formatMonthYearLabel(month: Int, year: Int): String =
    org.example.project.core.formatting.formatMonthYearLabel(month, year)
